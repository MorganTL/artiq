...
from artiq.gateware.cxp_grabber.core import CXP_Host_Core, ROI, Stream_Decoder
...
class CXP_Grabber(Module, AutoCSR):
    def __init__(
        ...
        self.submodules.core = core = CXP_Host_Core(tx.phys[0], rx.phys[0], sys_clk_freq)
        self.sync.rio += [
        ...
        self.submodules.stream_decoder = stream_decoder = Stream_Decoder(res_width)
